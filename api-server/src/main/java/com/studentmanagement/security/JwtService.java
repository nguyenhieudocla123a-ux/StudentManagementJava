...
public class JwtService {
    ...
    private static final String SECRET_KEY = "dGhpcyBpcyBhIHZlcnkgc2VjdXJlIHNlY3JldCBrZXkgZm9yIHN0dWRlbnQgbWFuYWdlbWVudA==";
    ...
    // 4. Tạo token với extra claims (role, maSV, maGV,...)
